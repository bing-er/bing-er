...
<p align="left">
  ...
  🌎 Vancouver, BC | 🎓 BCIT 2026 | 💡 Passionate about solving real-world problems with AI and secure computing
</p>
...
|---------|-------------|-------|
| 🔬 [**JAX-PAD: Differentiable Monte Carlo for Skin Optics**](https://github.com/bing-er/jax-pad-thesis) | Differentiable Monte Carlo framework that recovers 7-layer skin optical properties from surface reflectance via Pathwise Automatic Differentiation (PAD). Achieves prior-free StO₂ recovery at <1% error across 4 wavelengths (540–800 nm). Target: *Journal of Biomedical Optics*, ~Q3 2026. | Python, JAX, Google Colab (A100) |

---

## 🏆 Capstone & Featured Projects

| Project | Description | Tech Stack |
|---------|-------------|------------|
| 🎖️ [**Military Camouflage Object Detection**](https://github.com/bing-er/AI-final-project) | COMP 9130 capstone. Cross-domain transfer learning (animal → military camouflage) using SegFormer-B2. Best result: ACD1K mIoU 0.8592 / F1 0.8542 — exceeding success criteria of 0.65/0.75. | Python, PyTorch, HuggingFace, GPU (Colab) |
| 🏥 [**Predicting Hospital Readmission Risk**](https://github.com/bing-er/hospital-readmission-prediction) | Explainable ML (XGBoost, SHAP, LIME) predicting 30-day hospital readmissions using UCI Diabetes dataset. | Python, Scikit-learn, SHAP, LIME |
| 🧩 [**Pathfinding Optimization**](https://github.com/bing-er/pathfinding-optimization) | A\*, Dijkstra, and Jump Point Search comparison. | Python, Algorithms |
...
| 🌸 [**AI Activity VI**](https://github.com/bing-er/AI_Activities.git) | Transfer learning comparing ResNet50 and EfficientNetB0 on a 5-class wildlife dataset; feature extraction and fine-tuning (last 20 layers); best accuracy 95.7% | Python, TensorFlow, Keras, GPU (Colab) |
| 🧠 [**AI Activity VIII**](https://github.com/bing-er/AI_Activities.git) | Image segmentation with U-Net on Oxford-IIIT Pet dataset (pixel-level classification, IoU & Dice score) | Python, TensorFlow/Keras, GPU (Colab) |
| 🧠 [**AI Activity IX**](https://github.com/bing-er/AI_Activities.git) | NLP Sentiment Analysis with DistilBERT (Hugging Face, tokenization, attention analysis, PyTorch fine-tuning) | Python, PyTorch, Hugging Face Transformers |
...
| 🫁 [**AI Mini-Project 5**](https://github.com/bing-er/mini-project-5.git) | CNN-based chest X-ray pneumonia detection; baseline vs. augmented models with medical-focused evaluation (high recall emphasis) | Python, PyTorch, NumPy, Pandas |
| 🌸 [**AI Mini-Project 6**](https://github.com/bing-er/mini-project-6.git) | Transfer learning using ResNet50 on Oxford 102 Flowers; Feature Extraction vs Fine-Tuning with EarlyStopping and LR scheduling | Python, TensorFlow 2.x, Keras, Apple Silicon GPU |
| 🩸 [**AI Mini-Project 7**](https://github.com/bing-er/mini-project-7.git) | Blood cell object detection using YOLOv8 to identify RBC, WBC, and platelets in microscopy images | Python, YOLOv8 (Ultralytics), PyTorch, OpenCV |
| 🌊 [**AI Mini-Project 8**](https://github.com/bing-er/mini-project-8.git) | Flood region semantic segmentation in aerial imagery using U-Net with Dice-loss optimization | Python, TensorFlow/Keras, NumPy, OpenCV |
| 🛡️ [**AI Mini-Project 9**](https://github.com/bing-er/mini-project-9.git) | Transformer-based hate-speech detection; TF-IDF + Logistic Regression baseline vs fine-tuned DistilBERT | Python, PyTorch, Hugging Face Transformers, Scikit-learn |

---

## 🕵️ Cybersecurity & Network Projects

| Project | Description | Tech Stack |
|---------|-------------|------------|
| 🔍 [**Lateral Movement Detection**](https://github.com/bing-er/CyberSecurity_Project2) | COMP 9150 project. Graph-based + probabilistic NLL anomaly detection on LANL's 708M-event enterprise auth log. NLL model achieves AUC-ROC 0.9958 with zero false positives. | Python, NetworkX, Pandas, SciPy |
...
| 🖼️ [**PNG-Steganography-AES**](https://github.com/bing-er/PNG-Steganography-AES) | Image steganography with AES encryption. | Python |
| 🛰️ [**Find-My-Force**](https://bing-er.github.io/rf-tactical-dashboard/) | Tactical RF situational awareness dashboard prototype. | Web |
...
- [**AI-Assignment3**](https://github.com/bing-er/AI-Assignment3) – Deep learning model implemented using PyTorch.
...
**Overview:**  
RentRight is a rental listing and management prototype built in **Figma** for BCIT COMP 7082. Users can search for rental properties on an interactive map, filter results, and switch between **list** and **map** views.
...
**My Role:** UI/UX Design • Prototyping • Group Coordination • Testing  
