...
|----------|--------------|-------------|
| 🔦 [Monte-Carlo Photon Transport (Jacques Model)](https://github.com/bing-er/mc-forward-jacques) | High-performance forward Monte Carlo simulator for photon transport in turbid media, adapted from the Jacques MCML framework. Models HOP–DROP–SPIN–ROULETTE propagation, Henyey–Greenstein scattering, Fresnel interfaces, and multi-geometry fluence scoring. Optimized with Numba JIT (~200× speedup) for use in inverse and imaging applications. | Python, NumPy, Physics Modeling, LaTeX |
